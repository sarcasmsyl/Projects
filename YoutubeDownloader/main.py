...
class YoutubeVideo:
    ...
    def download_audio(self):
        try:
            ...
            video.download("YoutubeDownloader\Audio", filename_prefix="AudioOnly")
    ...
    def download_video(self):
        try:
            ...
            video.download("YoutubeDownloader\Video", filename_prefix="Video")
        except RegexMatchError as urlWrong:
            print('url entered incorrectly')
            tk.messagebox.showerror('Error', 'URL entered incorrectly')
...
def update_media_controls(player):
    ...
    # Volume control
    volume_scale = customtkinter.CTkSlider(master=frame, width=15, height=150, from_=0, to=100, orientation="vertical", command=set_volume)

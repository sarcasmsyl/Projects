...
fire_mode_test1 = font.render('Fire Mode : Single', True, white)
fire_mode_test2 = font.render('Fire Mode : AoE', True, white)
...
class Boss1_Enemy(pygame.sprite.Sprite):
    ...
    def basic_health(self):
        pygame.draw.rect(screen, (255,0,0), (550,100,self.target_health/self.health_ratio,50))
        pygame.draw.rect(screen, (255,255,255),(550,100,self.health_bar_length,25),8)
    ...
    def advanced_health(self):
        ...
        health_bar_rect = pygame.Rect(550,100,self.hp/self.health_ratio,50)
        transition_bar_rect = pygame.Rect(health_bar_rect.right,45,transition_width,50)
...
enemies = [Enemy(100,50)]
boss1 = Boss1_Enemy(540, 50)
while dummy < 35:
    dummy += 1
    testx += 50
    testy = 50
    var = Enemy(testx, testy)
    enemies.append(var)
